package logic.experiments.mcdepaper
...
/**
 * Correlation between the out come of the frst and second Monte Carlo Iteration.
 *
 ...
 * 6. estimator "R"
 */
object Cor12Iteration extends Experiment {
